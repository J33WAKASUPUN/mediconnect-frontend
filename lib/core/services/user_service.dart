...
class UserService extends BaseApiService {
  ...
  Future<List<Map<String, dynamic>>> getDoctorsForPatient(
    ...
    try {
      ...
      final response = await get('/auth/users',
          queryParams: {'role': 'doctor', 'patientId': patientId});
  ...
  Future<List<Map<String, dynamic>>> getAllDoctors() async {
    try {
      ...
      final response =
          await get('/auth/users', queryParams: {'role': 'doctor'});
  ...
  Future<List<Map<String, dynamic>>> getPatientsWhoMessaged() async {
    try {
      final response = await get('/users/patients/messaged');
      ...
      print('Error getting patients who messaged: $e');
      return [];
    }
  }
}
